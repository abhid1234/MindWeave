...
## 📝 Recent Updates
- **2026-02-20** - ✅ **Similar Content in Detail Dialog** — Added inline recommendations section to ContentDetailDialog so users discover related content while viewing an item. Reuses existing `getRecommendationsAction` and `RecommendationCard`. Deployed to Cloud Run (`gcr.io/mindweave-prod/mindweave:1b1f605`)
