...
- Use parallel tool execution liberally to keep main context window clean
- Offload research, exploration, and parallel analysis to parallel tool execution
- For complex problems, throw more compute at it via parallel tool execution
...
- **STATUS.md, GEMINI.md, and other docs-only changes** → commit and push only. **Never deploy** — these are not used at runtime
...
@.gemini/skills/claude-find-skills/SKILL.md
@.gemini/skills/seo-audit/SKILL.md
@.gemini/skills/status/SKILL.md
@.gemini/skills/test/SKILL.md
@.gemini/skills/test-driven-development/SKILL.md
